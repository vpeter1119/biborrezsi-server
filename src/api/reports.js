...
function validateInput(input, oldReports) {
	...
	console.log(lastReport.cold < input.cold + lastReport.hot < input.hot +| lastReport.heat < input.heat + lastReport.elec < input.elec + input.cold==0 + input.hot==0 + input.heat==0 + input.elec==0);
